...
from .views import index, dashboard, my_login, register, user_logout, food_consumption_update_destroy_view, food_consumption_create_view, update_delete_profile_API_view, product_list_API_view, profile_view, daily_consumption_list_view, retrieve_update_destroy_product_view        
urlpatterns = [
