...
from .views import index, dashboard,search_product, add_product, search_product_autocomplete_endpoint, my_login, register, user_logout, food_consumption_update_destroy_view, food_consumption_create_view, create_product, update_delete_profile_API_view, product_list_API_view, profile_view, daily_consumption_list_view, retrieve_update_destroy_product_view        
urlpatterns = [
    ...
    path('profile/<str:username>/food_consumption/add/', add_product, name='add_product'),
